			...
			<div class="col-md-3 left_col menu_fixed">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="${ctx}/manager/backend/main" class="site_title"><i
							...
							<ul class="nav side-menu">
								<li><a><i class="fa fa-home"></i> APP管理 <span
									...
									<ul class="nav child_menu">
										<li><a href="${ctx}/manager/backend/app/list">APP审核</a></li>
					...
					<div class="sidebar-footer hidden-small">
						<a data-toggle="tooltip" data-placement="top" title="Settings">
							...
							href="${ctx}/login/backend/logout"> <span
						...
						<ul class="nav navbar-nav navbar-right">
							<li class=""><a href="javascript:;"
								...
								aria-expanded="false"> <img
									src="${ctx}/statics/images/img.jpg" alt="">${userSession.userCode }
									<span class=" fa fa-angle-down"></span>
							</a>
								<ul class="dropdown-menu dropdown-usermenu pull-right">
									<li><a href="${ctx}/login/backend/logout"><i
							...
							<li role="presentation" class="dropdown">
								...
								<ul id="menu1" class="dropdown-menu list-unstyled msg_list"
									...
									<li><a> <span class="image"><img
												src="${ctx}/statics/images/img.jpg" alt="Profile Image" /></span>
